...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -734845568;
...
abstract class RustLibApi extends BaseApi {
  ...
  void scatterbrainApiMdnsServiceScannerScanNonblock(
      {required ServiceScanner that,
      required FutureOr<void> Function(List<HostRecord>) cb});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void scatterbrainApiMdnsServiceScannerScanNonblock(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kScatterbrainApiMdnsServiceScannerScanNonblockConstMeta,
      argValues: [that, cb],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kScatterbrainApiMdnsServiceScannerScanNonblockConstMeta =>
      const TaskConstMeta(
        debugName: "ServiceScanner_scan_nonblock",
        argNames: ["that", "cb"],
      );
  ...
  Identity dco_decode_identity(dynamic raw) {
    ...
    return Identity(
      ...
      extra: dco_decode_Map_String_list_prim_u_8_strict_None(arr[4]),
  ...
  Identity sse_decode_identity(SseDeserializer deserializer) {
    ...
    var var_extra =
        sse_decode_Map_String_list_prim_u_8_strict_None(deserializer);
  ...
  void sse_encode_identity(Identity self, SseSerializer serializer) {
    ...
    sse_encode_Map_String_list_prim_u_8_strict_None(self.extra, serializer);
...
class ServiceScannerImpl extends RustOpaque implements ServiceScanner {
  ...
  void scanNonblock({required FutureOr<void> Function(List<HostRecord>) cb}) =>
      RustLib.instance.api
          .scatterbrainApiMdnsServiceScannerScanNonblock(that: this, cb: cb);
